    ...
    class WeddingAudioPlayer {
        ...
        // ===== PROGRESS & UI UPDATES =====
        updateProgress() {
            // Could be used for progress bar if implemented
        ...
        updateVolumeDisplay() {
            ...
            // Update icon based on volume and playback state
            if (!this.isPlaying) {
        ...
        handleVisibilityChange(visible) {
            if (visible) {
                // Tab became visible - resume audio if it was playing
                if (this.isPlaying && this.audio.paused) {
                    this.audio.play().catch(console.error);
                }
            } else {
                // Tab became hidden - we don't pause audio, but could reduce volume
                if (this.isPlaying) {
                    // Optionally reduce volume when tab is not visible
        ...
        addEventListeners() {
            ...
            window.addEventListener('offline', () => {
                console.warn('Network offline - audio may be affected');
            });
        }
        ...
        handleAudioError() {
            ...
            this.showNotification('Unable to load audio. Please check your connection.', 'error');
            
            // Update audio control to show error state
            const audioControl = document.querySelector('.audio-control');
            if (audioControl) {
                audioControl.innerHTML = '❌';
        ...
        handlePlaybackError(error) {
            ...
            if (error.name === 'NotAllowedError') {
                this.showNotification('Please interact with the page to start audio', 'info');
                this.isUserInteracted = false;
            }
        }
