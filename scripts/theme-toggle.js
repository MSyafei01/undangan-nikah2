    ...
    function setLightTheme() {
        if (window.themeToggle) {
            window.themeToggle.setLightTheme();
        }
    }

    function setDarkTheme() {
        if (window.themeToggle) {
            window.themeToggle.setDarkTheme();
        }
    }

    function setSystemTheme() {
        if (window.themeToggle) {
            window.themeToggle.setSystemTheme();
        }
    }

    // ===== UTILITY FUNCTIONS =====
    function getCurrentTheme() {
        return window.themeToggle ? window.themeToggle.getThemeInfo() : null;
    }

    function isDarkTheme() {
        return window.themeToggle ? window.themeToggle.currentTheme === 'dark' : false;
    }

    function isLightTheme() {
        return window.themeToggle ? window.themeToggle.currentTheme === 'light' : false;
    }